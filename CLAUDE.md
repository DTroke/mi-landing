...
## Reglas personales del usuario

### Comunicación
- Always respond in English, even if i write in spanish - unless i explicitly ask for spanish.
- Si voy a hacer algo destructivo o costoso, avísame y espera confirmación
- Si no entiendes algo de mi prompt, pregúntame antes de adivinar

### Proceso de trabajo
- Para cualquier cambio que toque más de 2 archivos, primero dame un plan numerado y espera mi "OK"
- Después de cualquier cambio en HTML/CSS, abre `index.html` para que pueda verlo
- Antes de hacer commit, muéstrame qué archivos cambiaron y resumen de cambios

### Aprendizaje
- Soy principiante intermedio: explica brevemente las decisiones técnicas que tomes
- Si uso un término mal o tengo un concepto equivocado, corrígeme con cariño
- Si hay una forma mejor de hacer algo, dímelo aunque yo no haya preguntado